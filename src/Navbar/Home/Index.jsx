    ...
    return (<>
        ...
        <div id="default-carousel" class="relative w-full" data-carousel="slide">
            ...
            <div class="relative h-56 overflow-hidden md:h-96">
                {/* <!-- Item 1 --> */}
                {
                    CrowselAPI.map((data, id) => {
                        return <>
                            <div key={id} className="hidden duration-700 ease-in-out" data-carousel-item>
                                <img src={data.image} className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
                                <span classNameName="absolute font-mono text-transparent bg-clip-text bg-gradient-to-r from-[#111827] to-white drop-shadow-2xl  md:text-[2rem] font-semibold  -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 sm:text-3xl  ">{data.title}</span>
                            </div>
                        </>
                    })
                }
